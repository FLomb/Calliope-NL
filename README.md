...
- Renewable potentials (land availability) are based on those from the [Euro-Calliope](https://euro-calliope.readthedocs.io/en/stable/) project, but have been manually adjusted based on specific knowledge of the Dutch context
...
- The expansion of transmission capacity is simplified: each intra-national line can be expanded to a maximum of 5x the current capacity, while international connectors are kept at current capacity
